            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b class="sys_item_price">${result.retailPrice!"无"}</b>  </dd>
                    </li>
                    <li class="price iteminfo_mktprice">
                        <dt>原价</dt>
                        <dd><em>¥</em><b class="sys_item_mktprice">${result.counterPrice!"无"}</b></dd>
                    </li>
                    <div class="clear"></div>
                </div>
                ...
                <dl class="iteminfo_parameter sys_item_specpara">
                            ...
                            <div class="theme-popbod dform">
                                <form class="theme-signin" name="loginform" action="" method="post">
                                    ...
                                    <div class="theme-signin-left">
                                        ...
                                        <#list result.parameterSet?keys as key>
                                            <div class="theme-options">
                                                <div class="cart-title">${key}</div>
                                                <ul>
                                                    <#list result.parameterSet[key] as item>
                                                        <li class="sku-line">${item}<i></i></li>
                                                    </#list>
                                                </ul>
                                            </div>
                                        </#list>
                    ...
                    <dd>
                        ...
                        <span id="Stock" class="tb-hidden">库存<span class="stock">${result.number}</span>件</span>
                    </dd>
